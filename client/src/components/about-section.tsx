        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <Card className="glass-effect border-slate-700/50 bg-slate-800/20">
            <CardContent className="p-8">
              <h3 className="text-2xl font-bold mb-6 text-blue-400" data-testid="text-journey">
                My Journey
              </h3>
          ...
          <div className="grid grid-cols-2 gap-6">
            {features.map((feature, index) => (
              <Card 
                key={index}
                className="glass-effect border-slate-700/50 bg-slate-800/20 text-center hover:scale-105 transition-transform"
